...
USER_ODOO = os.getenv("ODOO_USER", "chat.teste")
PW_ODOO = os.getenv("ODOO_PASSWORD", "@parada2024")
...
IGNORAR_FILTRO_TOTAL = _env_bool("IGNORAR_FILTRO_TOTAL", "true")
LIMITE_CASOS_TESTE = max(1, int(os.getenv("LIMITE_CASOS_TESTE", "100")))
...
6. Se houver tutela específica consistente em excluir registro, rest